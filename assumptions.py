...
# Local game execution constants
WESNOTH_STATE_TIMEOUT = 30.0  # Maximum time to wait for Wesnoth to produce state (seconds)
GAME_STARTUP_TIMEOUT = 60.0  # Maximum time for game to start (seconds)