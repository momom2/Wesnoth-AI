<!-- Archived 2026-09-04: the pre-restart backlog, verbatim. The live backlog is BACKLOG.md at the repo root. -->
...
2026-07-28..31 autonomous run is `docs/archive/autonomous_run.md`; established
...
## ladder in docs/archive/redesign_1000x_20260828.md).
...
## protocol). docs/archive/leg5_resume_verdict_20260826.md has the record.
...
1. Read leg az4's pins in `/workspace/az_history.csv` on box
   ...
   `docs/archive/az_minimal_spec.md`: raw player not worse than the seed
   ...
   not the step rule. Record: `docs/archive/az_leg_20260903.md`.
...
0. **TCS is INTEGRATED, DEFAULT ON (user ruling 2026-08-14).** The
   ...
   in `docs/archive/tcs_spec.md` §Integration: no boundary value-only
   ...
   auxiliary, default ON (`wesnoth_ai/gbc.py`, docs/archive/gbc_spec.md).
   ...
   (`docs/archive/planning_abstractions_litreview_20260812.md`).
   ...
   **ROOT-CAUSE REPORT (2026-08-17, 17-agent Opus workflow):
   `docs/archive/leg3_passivity_rootcause_20260817.md` — READ IT before any
...
1. 🟡 **Revisit the luck compensator** (user directive 2026-08-17).
   ...
   tool (rho^2 0.03/0.05, docs/archive/credit_assignment_design_20260817.md
...
2. 🟡 **Hindsight credit assignment — idea parked, mechanism
   ...
   docs/archive/credit_assignment_design_20260817.md Q11.
...
6. **Self-play handoff design (the next big decision)** — the
   2026-08-10 literature scan (docs/archive/literature_scan_20260810.md,
...
- **2026-08-04 eval results (full detail: `docs/archive/tier_b_brief.md` +
  `docs/eval_box.md`):**
...
"Where the project stands" above and `docs/archive/tier_b_brief.md`).** What
...
- **DECISION (user, 2026-08-02) — Tier-b directly**, accepting that
  ...
  number from it is interpretable** — see `docs/archive/tier_b_runbook.md` §3
  and `docs/archive/superhuman_training_plan.md` §11. Box is parked, not booked.
