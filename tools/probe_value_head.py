...
def main(argv: List[str]) -> int:
    ...
    for ck in args.checkpoints:
        ...
        p = TransformerPolicy(
            ...
            # ALL optional heads must be carried. The constructor
            # defaults them off, and load_checkpoint only WARNS about
            # the resulting unexpected keys (probing a structurally
            # different model than the one that trained).
