...
This module takes a scenario's .cfg as wesnoth_ai/rules/scenario_cfg.py
reads it, and exposes the events as a list keyed by trigger name.
Callers (the replay-dataset reconstructor) ask for events by trigger
and apply their action tags to the running `GameState`.
...
__all__ = [
    "ScenarioEvent", "load_events_for_scenario",
    ...
    "unmodelled_action_counts", "reset_unmodelled_actions",
]
