...
def test_enumerate_legal_actions_with_priors_includes_type_idx():
    ...
    end_turn keep type_idx=None. (Rewritten gate-free 2026-08-10 when
    FORBID_IDLE_END_TURN was deleted: end_turn is now always legal,
    per the mask contract — humans end turns with MP remaining.)"""
    ...
    # Unit at (3,3) + enemy at (4,3): unit actions exist, and
    # end_turn is legal alongside them (no idle gate).
